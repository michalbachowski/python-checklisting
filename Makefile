...
zipapp:
	...
	python -mzipapp ./src -o ./dist/checklisting.pyz -p '/usr/bin/env python3' -m 'checklisting.cli:main'
...
call_local:
	PYTHONPATH=src/:$(PYTHONPATH) python3 -mchecklisting external -s 127.0.0.1:8080
